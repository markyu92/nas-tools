...
class RBACUserRepositoryAdapter(IRBACUserRepository):
    ...
    def get_users(self, page: int = 1, page_size: int = 20, status: int | None = None) -> tuple[list[RBACUserEntity], int]:
    ...
    def create_user(self, username: str, password_hash: str, email: str | None = None, nickname: str | None = None, is_superadmin: int = 0) -> RBACUserEntity:
...
class RBACRoleRepositoryAdapter(IRBACRoleRepository):
    ...
    def create_role(self, role_name: str, role_code: str, description: str | None = None, role_level: int = 100) -> RBACRoleEntity:
...
class RBACPermissionRepositoryAdapter(IRBACPermissionRepository):
    ...
    def get_all_permissions(self, module: str | None = None, permission_type: str | None = None) -> list[RBACPermissionEntity]:
    ...
    def create_permission(self, permission_name: str, permission_code: str, permission_type: str = 'api', module: str | None = None, description: str | None = None) -> RBACPermissionEntity:
...
class RBACMenuRepositoryAdapter(IRBACMenuRepository):
    ...
    def create_menu(self, menu_name: str, menu_code: str, parent_id: int | None = None, path: str | None = None, icon: str | None = None, component: str | None = None, sort_order: int = 0, menu_level: int = 1, permission_code: str | None = None, **kwargs) -> RBACMenuEntity:
...
class RBACLogRepositoryAdapter(IRBACLogRepository):
    ...
    def add_login_log(self, user_id: int, username: str, login_ip: str | None = None, login_location: str | None = None, user_agent: str | None = None, login_type: str = 'password', login_status: int = 1, fail_reason: str | None = None) -> RBACUserLoginLogEntity:
    ...
    def get_login_logs(self, user_id: int | None = None, page: int = 1, page_size: int = 20) -> tuple[list[RBACUserLoginLogEntity], int]:
    ...
    def add_operation_log(self, user_id: int | None = None, username: str | None = None, module: str | None = None, operation_type: str = 'QUERY', description: str | None = None, request_method: str | None = None, request_url: str | None = None, request_params: str | None = None, response_data: str | None = None, operation_ip: str | None = None, execution_time: int | None = None, operation_status: int = 1, error_msg: str | None = None) -> RBACOperationLogEntity:
    ...
    def get_operation_logs(self, user_id: int | None = None, module: str | None = None, page: int = 1, page_size: int = 20) -> tuple[list[RBACOperationLogEntity], int]:
