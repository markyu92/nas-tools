...
DEFAULT_MENUS = [
    ...
    },
    {
        ...
        "children": [
            {"name": "排行榜", "code": "Ranking", "path": "/discovery/ranking", "icon": "lucide:trophy", "component": "/media/discovery/index", "sort_order": 1, "level": 2, "permission_code": "discovery:view"},
            {"name": "豆瓣电影", "code": "DoubanMovie", "path": "/discovery/douban-movie", "icon": "lucide:film", "component": "/media/discovery/index", "sort_order": 2, "level": 2, "permission_code": "discovery:view"},
            {"name": "豆瓣电视剧", "code": "DoubanTv", "path": "/discovery/douban-tv", "icon": "lucide:tv", "component": "/media/discovery/index", "sort_order": 3, "level": 2, "permission_code": "discovery:view"},
    ...
    },
    {
        ...
        "children": [
            {"name": "站点维护", "code": "SiteMaintenance", "path": "/site/list", "icon": "lucide:server", "component": "/site/list/index", "sort_order": 1, "level": 2, "permission_code": "site:view"},
            {"name": "数据统计", "code": "SiteStatistics", "path": "/site/statistics", "icon": "lucide:clock", "component": "/site/statistics/index", "sort_order": 2, "level": 2, "permission_code": "site:view"},
            {"name": "刷流任务", "code": "BrushTask", "path": "/brush", "icon": "lucide:menu", "component": "/brush/index", "sort_order": 3, "level": 2, "permission_code": "site:manage"},
            {"name": "站点资源", "code": "SiteResources", "path": "/site/resources", "icon": "lucide:database", "component": "/site/resources/index", "sort_order": 4, "level": 2, "permission_code": "site:view"},
        ]
    },
    {
        "name": "订阅管理",
        ...
        "children": [
            {"name": "电影订阅", "code": "MovieRss", "path": "/rss/movie", "icon": "lucide:film", "component": "/rss/movie/index", "sort_order": 1, "level": 2, "permission_code": "rss:view"},
            {"name": "电视剧订阅", "code": "TvRss", "path": "/rss/tv", "icon": "lucide:tv", "component": "/rss/tv/index", "sort_order": 2, "level": 2, "permission_code": "rss:view"},
            {"name": "订阅历史", "code": "RssHistory", "path": "/rss/history", "icon": "lucide:history", "component": "/rss/history/index", "sort_order": 3, "level": 2, "permission_code": "rss:view"},
            {"name": "订阅日历", "code": "RssCalendar", "path": "/rss/calendar", "icon": "lucide:calendar-days", "component": "/rss/calendar/index", "sort_order": 4, "level": 2, "permission_code": "rss:view"},
            {"name": "自定义订阅", "code": "UserRss", "path": "/rss/user", "icon": "lucide:file-text", "component": "/rss/user/index", "sort_order": 5, "level": 2, "permission_code": "rss:manage"},
        ]
    },
    {
        "name": "下载管理",
        ...
        "children": [
            {"name": "正在下载", "code": "Downloading", "path": "/download/downloading", "icon": "lucide:loader", "component": "/download/downloading/index", "sort_order": 1, "level": 2, "permission_code": "download:view"},
            {"name": "近期下载", "code": "DownloadHistory", "path": "/download/history", "icon": "lucide:clock", "component": "/download/history/index", "sort_order": 2, "level": 2, "permission_code": "download:view"},
            {"name": "自动删种", "code": "TorrentRemove", "path": "/download/torrent-remove", "icon": "lucide:trash-2", "component": "/download/torrent-remove/index", "sort_order": 3, "level": 2, "permission_code": "download:manage"},
            {"name": "下载设置", "code": "DownloadSettings", "path": "/download/settings", "icon": "lucide:sliders-horizontal", "component": "/download/settings/index", "sort_order": 4, "level": 2, "permission_code": "download:manage"},
        ]
    },
    {
        "name": "媒体整理",
        ...
        "children": [
            {"name": "识别历史", "code": "RenameHistory", "path": "/rename/history", "icon": "lucide:history", "component": "/rename/history/index", "sort_order": 1, "level": 2, "permission_code": "library:view"},
            {"name": "文件管理", "code": "RenameMediafile", "path": "/rename/mediafile", "icon": "lucide:folder-open", "component": "/rename/mediafile/index", "sort_order": 2, "level": 2, "permission_code": "library:manage"},
            {"name": "未识别列表", "code": "RenameUnidentification", "path": "/rename/unidentification", "icon": "lucide:help-circle", "component": "/rename/unidentification/index", "sort_order": 3, "level": 2, "permission_code": "library:manage"},
            {"name": "TMDB 黑名单", "code": "RenameBlacklist", "path": "/rename/blacklist", "icon": "lucide:shield-ban", "component": "/rename/blacklist/index", "sort_order": 4, "level": 2, "permission_code": "library:manage"},
        ]
    },
    {
        "name": "服务",
        ...
        "children": [
            {"name": "服务面板", "code": "ServicePanel", "path": "/service/panel", "icon": "lucide:layout-grid", "component": "/service/panel/index", "sort_order": 1, "level": 2, "permission_code": "service:view"},
            {"name": "调度任务", "code": "SchedulerJobs", "path": "/service/scheduler", "icon": "lucide:clock", "component": "/scheduler/jobs/index", "sort_order": 2, "level": 2, "permission_code": "service:view"},
        ]
    },
    {
        "name": "系统设置",
        ...
        "children": [
            {"name": "基础设置", "code": "SystemBasic", "path": "/system/basic", "icon": "lucide:sliders-horizontal", "component": "/system/basic/index", "sort_order": 1, "level": 2, "permission_code": "setting:view"},
            {"name": "媒体库设置", "code": "SystemLibrary", "path": "/system/library", "icon": "lucide:tv", "component": "/system/library/index", "sort_order": 2, "level": 2, "permission_code": "setting:view"},
            {"name": "目录同步", "code": "SystemSync", "path": "/system/sync", "icon": "lucide:refresh-cw", "component": "/sync/index", "sort_order": 3, "level": 2, "permission_code": "setting:view"},
            {"name": "下载器设置", "code": "SystemDownloader", "path": "/system/downloader", "icon": "lucide:download", "component": "/download/downloader/index", "sort_order": 4, "level": 2, "permission_code": "setting:view"},
            {"name": "索引器设置", "code": "SystemIndexer", "path": "/system/indexer", "icon": "lucide:search", "component": "/service/indexer/index", "sort_order": 5, "level": 2, "permission_code": "setting:view"},
            {"name": "媒体服务器", "code": "SystemMediaserver", "path": "/system/mediaserver", "icon": "lucide:server", "component": "/service/mediaserver/index", "sort_order": 6, "level": 2, "permission_code": "setting:view"},
            {"name": "通知设置", "code": "SystemNotification", "path": "/system/notification", "icon": "lucide:bell", "component": "/service/notification/index", "sort_order": 7, "level": 2, "permission_code": "setting:view"},
            {"name": "自定义识别词", "code": "SystemWords", "path": "/system/words", "icon": "lucide:file-text", "component": "/words/index", "sort_order": 8, "level": 2, "permission_code": "setting:view"},
            {"name": "过滤规则", "code": "SystemFilter", "path": "/system/filter", "icon": "lucide:funnel", "component": "/filter/rule/index", "sort_order": 9, "level": 2, "permission_code": "setting:view"},
    ...
    },
    {
        ...
        "children": [
            {"name": "插件市场", "code": "PluginMarket", "path": "/plugin/market", "icon": "lucide:store", "component": "/plugin/market/index", "sort_order": 1, "level": 2, "permission_code": "plugin:view"},
            {"name": "已安装插件", "code": "PluginInstalled", "path": "/plugin/installed", "icon": "lucide:box", "component": "/plugin/installed/index", "sort_order": 2, "level": 2, "permission_code": "plugin:view"},
        ]
    },
    {
        "name": "日志",
...
DEFAULT_ROLES = [
    ...
    },
    {
        ...
        "menus": [
            ...
            "Rename", "RenameHistory", "RenameMediafile", "RenameUnidentification", "RenameBlacklist",
            "Service", "ServicePanel", "SchedulerJobs",
            "Logs",
            "System", "SystemBasic", "SystemLibrary", "SystemSync", "SystemDownloader",
            "SystemIndexer", "SystemMediaserver", "SystemNotification", "SystemWords", "SystemFilter",
            "SystemUsers", "SystemRoles", "SystemMenus",
            "Plugin", "PluginMarket", "PluginInstalled",
            "About",
        ]
    },
    {
