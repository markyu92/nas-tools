...
class Torrent:
    """种子信息 DTO"""
    id: Optional[str] = None                            # 种子id
    name: Optional[str] = None                          # 种子名称
    size: int = 0                                       # 种子大小
    downloaded: int = 0                                 # 下载量
    uploaded: int = 0                                   # 上传量
    ratio: float = 0                                    # 分享率
    add_time: Optional[str] = None                      # 种子添加时间
    ...
    status: Optional[TorrentStatus] = None              # 种子状态
    save_path: Optional[str] = None                     # 保存路径
    content_path: Optional[str] = None                  # 文件完整路径
