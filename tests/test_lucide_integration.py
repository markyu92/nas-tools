...
class TestLucideIntegration:
    ...
    def test_navigation_html_contains_lucide_script(self):
        ...
        with open("web/templates/navigation.html", encoding="utf-8") as f:
            content = f.read()
    ...
    def test_navbar_component_uses_lucide_icons(self):
        ...
        with open("web/static/components/layout/navbar/index.js", encoding="utf-8") as f:
            content = f.read()
...
class TestMenuDataStructure:
    ...
    def test_user_model_get_usermenus_returns_icon(self):
        ...
        with open("web/backend/user.py", encoding="utf-8") as f:
            content = f.read()
    ...
    def test_menu_model_has_icon_field(self):
        ...
        # 直接读取源代码检查
        with open("app/db/models/rbac.py", encoding="utf-8") as f:
            content = f.read()
